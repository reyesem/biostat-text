# Assessing the Conditions for the General Linear Model {#sec-glm-assessing-conditions}
...
```{r}
#| label: tbl-glm-assessing-conditions-residual-plots
#| tbl-cap: Method of graphical assessment for the conditions of the classical regression model.
#| echo: false
